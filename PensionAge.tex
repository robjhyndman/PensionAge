...
\todo{should it be $p^+$} refers to migration in calendar year \(t\) of
...
1921--2014.\todo{Han has updated the data period.} The start-year
...
levels.\todo{In the table, I set the beginning year to 2015 instead of 2016.}
...
\todo{code are missing for two figures} and its 80\% confidence level
